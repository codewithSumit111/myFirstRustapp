...
```mermaid
graph TD
  3e5e841e["ERC-721 NFT"]
  5b9f8438["Frontend"]
  a7e0ba36["Wallet Auth"]
  3e5e841e --> 5b9f8438
  5b9f8438 --> a7e0ba36
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--3e5e841e.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--5b9f8438.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--a7e0ba36.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--3e5e841e.md)
- [Frontend](.nskills/components/frontend-scaffold--5b9f8438.md)
- [Wallet Auth](.nskills/components/wallet-auth--a7e0ba36.md)
